...
public class RoundedImageView extends ImageView {
    ...
    public static final int BG_MODE_END = 2;
    public static final int BG_MODE_FILL = 3;
    public static final int BG_MODE_START = 4;
    ...
    private boolean mMutateBackground = true;
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mScaleSize = a.getFloat(R.styleable.RoundedImageView_riv_scale, 1.1f);
        ...
        mMutateBackground = a.getBoolean(R.styleable.RoundedImageView_riv_mutate_background, true);
        mBackgroundMode =
                a.getInt(R.styleable.RoundedImageView_riv_bg_mode, BG_MODE_CENTER);
        RoundedDrawable.SCALETOFIT = mBackgroundMode;
    ...
    public void setScaleSize(float mScaleSize) {
