...
public class RoundedDrawable extends Drawable {
    ...
    public static int SCALETOFIT = 1;
...
//                changeScaleToFit(SCALETOFIT);
    ...
    private void changeScaleToFit(int ScaleToFit){
        Log.d(TAG, "changeScaleToFit() called with: ScaleToFit = [" + ScaleToFit + "]");
        switch (ScaleToFit) {
            case RoundedImageView.BG_MODE_CENTER:
                mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.CENTER);
                break;
            case RoundedImageView.BG_MODE_END:
                mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.END);
                break;
            case RoundedImageView.BG_MODE_FILL:
                mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.FILL);
                break;
            case RoundedImageView.BG_MODE_START:
                mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.START);
                break;
            default:
                mShaderMatrix.setRectToRect(mBitmapRect, mBorderRect, Matrix.ScaleToFit.CENTER);
                break;
